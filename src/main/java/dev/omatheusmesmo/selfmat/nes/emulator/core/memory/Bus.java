...
public class Bus {
    ...
    public byte read(int address) {
        ...
        // The cases are based on 4KB blocks (0x1000) or 1KB blocks (0x400) for finer grain.
        switch (address & 0xF000) { // Check the highest 4 bits
            case RAM_START_ADDRESS: // 0x0000 - 0x0FFF: RAM and its mirror
            case RAM_START_ADDRESS + 0x1000: // 0x1000 - 0x1FFF: RAM mirror
            ...
            case PPU_REGISTERS_START + 0x1000: // 0x3000 - 0x3FFF: PPU mirror
                // Need to normalize to 0x2000-0x2007 for PPU logic
            ...
            case APU_IO_START_ADDRESS: // 0x4000 - 0x4FFF: APU/IO and Cartridge
                ...
                // Fallthrough to Cartridge if not APU/IO
